...
//       let notificationData = "Deutsche Care Alert - You task deadline is reaching soon!";
//       notificationData = "Request Data"+JSON.stringify(req.body);
//       if(req.data){
...
//             title: "DeutscheCare+ Reminder Alert!",
//             appName: "DeutscheCare+",
